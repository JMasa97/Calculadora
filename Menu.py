...
def regreso ():
    ...
    if mensaje == 'yes':
       ...
       canvas1.create_window(200, 250, window=buttonmaster)
    else:
        return
def todos ():
...
def param ():
        canvas1.delete("all")
        canvas1.config(width=400,height=300)
        label1 = tk.Label(root, text='Parametros "z", "y" y "s"')
        label1.config(font=('helvetica', 14))
        canvas1.create_window(200, 25, window=label1)
        label2 = tk.Label(root, text='¿Que parametros desea utilizar?')
        label2.config(font=('helvetica', 10))
        canvas1.create_window(200, 50, window=label2)
        button1 = tk.Button (root, text='Parametros z',command=opparamz,bg='steelblue',fg='white') 
        button3 = tk.Button (root, text='Parametros y',command=opparamy,bg='mediumorchid',fg='white')
        button4 = tk.Button (root, text='Parametros s',command=opparams,bg='darkkhaki',fg='white') 
        button2 = tk.Button (root, text='Regresar al menú principal',command=regreso,bg='red4',fg='white')
        canvas1.create_window(200, 80, window=button1)
        canvas1.create_window(200, 120, window=button3)
        canvas1.create_window(200, 160, window=button4)
...
def linkbudg():
    ...
    label.config(font=('helvetica', 14))
    canvas1.create_window(400, 50, window=label)
    label0 = tk.Label(root, text=""" Un Link Budget es el término utilizado para referirse a la potencia recibida en el receptor.
    Esto incluye todas las ganancias y pérdidas en los cables / fibras, antenas, amplificadores y otros componentes en la cadena 
    desde el transmisor hasta el punto en el que lo recibe el receptor, además de las pérdidas de propagación cuando se viaja por 
    aire u otro medio.
    """)
    ...
    label1 = tk.Label(root, text= 'Introduzca la Potencia de salida del transmisor (P_Tx(dbm))')
    label1.config(font=('helvetica', 10))
    canvas1.create_window(400, 200, window=label1)
    print(canvas1.create_window(400, 240, window=entry20))
    label2 = tk.Label(root, text= 'Introduzca la Ganancia de la antena transmisora (G_Tx(dbm))')
    label2.config(font=('helvetica', 10))
    canvas1.create_window(400, 270, window=label2)
    print(canvas1.create_window(400, 310, window=entry21))
    label3 = tk.Label(root, text= 'Introduzca la Pérdida total del transmisor (L_Tx(dbi))')
    label3.config(font=('helvetica', 10))
    canvas1.create_window(400, 340, window=label3)
    print(canvas1.create_window(400, 380, window=entry22))
    label4 = tk.Label(root, text= 'Introduzca la Pérdida en el espacio (L_FS(db))')
    label4.config(font=('helvetica', 10))
    canvas1.create_window(400, 410, window=label4)
    print(canvas1.create_window(400, 450, window=entry23))
    label5 = tk.Label(root, text= 'Introduzca la Pérdida miscelánea (L_M(db))')
    label5.config(font=('helvetica', 10))
    canvas1.create_window(400, 480, window=label5)
    print(canvas1.create_window(400, 510, window=entry24))
    label6 = tk.Label(root, text= 'Introduzca la Ganancia de la antena receptora (G_Rx(dbi))')
    label6.config(font=('helvetica', 10))
    canvas1.create_window(400, 540, window=label6)
    print(canvas1.create_window(400, 570, window=entry25))
    label7 = tk.Label(root, text= 'Introduzca las Pérdidas en el receptor (L_Rx(db))')
...
def linkbudgop():
    canvas1.delete("all")
    canvas1.config(width=800,height=670)
    pt = float(entry19.get())
    gt = float(entry20.get())
    lt = float(entry21.get())
    lfs = float(entry22.get())
    lm = float(entry23.get())
    ...
    canvas1.create_window(400, 100, window=label0)
    print(canvas1.create_window(400, 170, window=entry19))
    label1 = tk.Label(root, text= 'Introduzca la Potencia de salida del transmisor (P_Tx(db))')
    label1.config(font=('helvetica', 10))
    canvas1.create_window(400, 200, window=label1)
    print(canvas1.create_window(400, 240, window=entry20))
    label2 = tk.Label(root, text= 'Introduzca la Ganancia de la antena transmisora (G_Tx(db))')
    label2.config(font=('helvetica', 10))
    canvas1.create_window(400, 270, window=label2)
    print(canvas1.create_window(400, 310, window=entry21))
    label3 = tk.Label(root, text= 'Introduzca la Pérdida total del transmisor (L_Tx(db))')
    label3.config(font=('helvetica', 10))
    canvas1.create_window(400, 340, window=label3)
    print(canvas1.create_window(400, 380, window=entry22))
    label4 = tk.Label(root, text= 'Introduzca la Pérdida en el espacio (L_FS(db))')
    ...
    canvas1.create_window(400, 480, window=label5)
    print(canvas1.create_window(400, 510, window=entry24))
    label6 = tk.Label(root, text= 'Introduzca la Ganancia de la antena receptora (G_Rx(db))')
    label6.config(font=('helvetica', 10))
    canvas1.create_window(400, 540, window=label6)
    print(canvas1.create_window(400, 570, window=entry25))
    label7 = tk.Label(root, text= 'Introduzca las Pérdidas en el receptor (L_Rx(db))')
...
def opmenu ():   
    ...
    if x1==int(1):
        ...
        label4 = tk.Label(root, text= 'Opcion Inexistente, seleccione de nuevo porfavor')
        label4.config(font=('helvetica', 10))
        canvas1.create_window(200, 170, window=label4)
def opparams():
    canvas1.delete("all")
    canvas1.config(width=800,height=850)
    label = tk.Label(root, text='Parametros S')
    label.config(font=('helvetica', 14))
    canvas1.create_window(400, 50, window=label)
    print(canvas1.create_window(400, 200, window=entry13))
    label1 = tk.Label(root, text= 'Introduzca la Sa')
    label1.config(font=('helvetica', 10))
    canvas1.create_window(400, 250, window=label1)
    print(canvas1.create_window(400, 300, window=entry14))
    label2 = tk.Label(root, text= 'Introduzca la Sb')
    label2.config(font=('helvetica', 10))
    canvas1.create_window(400, 350, window=label2)
    print(canvas1.create_window(400, 400, window=entry15))
    label3 = tk.Label(root, text= 'Introduzca la Sc')
    label3.config(font=('helvetica', 10))
    canvas1.create_window(400, 450, window=label3)
    button1 = tk.Button(text='Presione para procesar sus datos', command=opparams1, bg='orange', fg='white', font=('helvetica', 9, 'bold'))
...
def opparams1():
    ...
    z21=Zc
    z22=Zb+Zc
    labell = tk.Label(root, text= (z11))
    labell.config(font=('helvetica', 14))
    canvas1.create_window(400, 60, window=labell)
    labell2 = tk.Label(root, text= (z12))
    labell2.config(font=('helvetica', 14))
    canvas1.create_window(400, 60, window=labell2)
    labell3 = tk.Label(root, text= (z21))
    labell3.config(font=('helvetica', 14))
    canvas1.create_window(400, 60, window=labell3)
    label4 = tk.Label(root, text= (z22))
    label4.config(font=('helvetica', 14))
    canvas1.create_window(400, 60, window=label4)
    label = tk.Label(root, text='Parametros S')
    label.config(font=('helvetica', 14))
    canvas1.create_window(400, 50, window=label)
    ...
    label3.config(font=('helvetica', 10))
    canvas1.create_window(400, 450, window=label3)
    button1 = tk.Button(text='Presione para procesar sus datos', command=opparamz1, bg='orange', fg='white', font=('helvetica', 9, 'bold'))
    canvas1.create_window(400, 790, window=button1)
    button2 = tk.Button (root, text='Regresar al menú principal',command=regreso,bg='red4',fg='white')
    canvas1.create_window(600, 830, window=button2)
    button3 = tk.Button (root, text='Regresar al menú de parametros',command=param,bg='ivory3',fg='white')
...
def opparamy():
    canvas1.delete("all")
    canvas1.config(width=800,height=850)
    label = tk.Label(root, text='Parametros Y')
    label.config(font=('helvetica', 14))
    canvas1.create_window(400, 50, window=label)
    print(canvas1.create_window(400, 200, window=entry13))
    label1 = tk.Label(root, text= 'Introduzca la Ya')
    label1.config(font=('helvetica', 10))
    canvas1.create_window(400, 250, window=label1)
    print(canvas1.create_window(400, 300, window=entry14))
    label2 = tk.Label(root, text= 'Introduzca la Yb')
    label2.config(font=('helvetica', 10))
    canvas1.create_window(400, 350, window=label2)
    print(canvas1.create_window(400, 400, window=entry15))
    label3 = tk.Label(root, text= 'Introduzca la Yc')
    label3.config(font=('helvetica', 10))
    canvas1.create_window(400, 450, window=label3)
    button1 = tk.Button(text='Presione para procesar sus datos', command=opparamy1, bg='orange', fg='white', font=('helvetica', 9, 'bold'))
    canvas1.create_window(400, 790, window=button1)
    button2 = tk.Button (root, text='Regresar al menú principal',command=regreso,bg='red4',fg='white')
    canvas1.create_window(600, 830, window=button2)
    button3 = tk.Button (root, text='Regresar al menú de parametros',command=param,bg='ivory3',fg='white')
...
def opparamz():
    canvas1.delete("all")
    canvas1.config(width=800,height=850)
    label = tk.Label(root, text='Parametros Z')
    label.config(font=('helvetica', 14))
    canvas1.create_window(400, 50, window=label)
    print(canvas1.create_window(400, 200, window=entry13))
    label1 = tk.Label(root, text= 'Introduzca la Za')
    label1.config(font=('helvetica', 10))
    canvas1.create_window(400, 250, window=label1)
    print(canvas1.create_window(400, 300, window=entry14))
    label2 = tk.Label(root, text= 'Introduzca la Zb')
    label2.config(font=('helvetica', 10))
    canvas1.create_window(400, 350, window=label2)
    print(canvas1.create_window(400, 400, window=entry15))
    label3 = tk.Label(root, text= 'Introduzca la Zc')
    label3.config(font=('helvetica', 10))
    canvas1.create_window(400, 450, window=label3)
    button1 = tk.Button(text='Presione para procesar sus datos', command=opparamz1, bg='orange', fg='white', font=('helvetica', 9, 'bold'))
    canvas1.create_window(400, 790, window=button1)
